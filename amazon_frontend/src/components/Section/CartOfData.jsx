  ...
  return (
    ...
    <div className="container mx-auto p-4 grid gap-8 grid-cols-1 lg:grid-cols-4 ">
      ...
      <div className="bg-white shadow-md rounded-lg p-4">
        <h3 className="text-xl font-bold mb-4">Deals based on your shopping trends</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <img
              src={img5}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <img
              ...
              className="w-full rounded-md"
            />
            <p className="font-medium mt-2">Smart watches</p>
            <span className="text-sm text-gray-500">1 viewed</span>
          </div>
          <div className="text-center">
            <img
              ...
              className="w-full rounded-md"
            />
            <p className="font-medium mt-2">Men's sports shorts</p>
            <span className="text-sm text-gray-500">1 viewed</span>
          </div>
          <div className="text-center">
            <img
              ...
              className="w-full rounded-md"
            />
            <p className="font-medium mt-2">Televisions</p>
            <span className="text-sm text-gray-500">1 viewed</span>
          </div>
          <div className="text-center">
            <img
              ...
              className="w-full rounded-md"
            />
            <p className="font-medium mt-2">Smartphones & basic phones</p>
            <span className="text-sm text-gray-500">2 viewed</span>
          </div>
        </div>
